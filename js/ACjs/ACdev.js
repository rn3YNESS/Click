////// PRIVATE MENIFA FUNCTIONS ////////
   ...
   function getDbItems(columnObj, sourceTable, sourceColumn) { //debugger;
			...
			//var ajaxUrl = encodeURI("http://devportal16:3333/api/User/GetTableCol/?tableName=" +sourceTable+ "&colName=" +sourceColumn+ "&filter="+columnValue);
...
//debugger;				
	    ...
	    //columnObj.after("<img id='" + containerArrId + "' src='/Style%20Library/Mali/ewr074.gif' style='width:18px; vertical-align: top'; title='Click AutoComplete'/>");
	    columnObj.after("<img id='" + containerArrId + "' src='/menifa/ewr074.gif' style='width:20px; vertical-align: bottom'; title='Click AutoComplete'/>");
...
//debugger;			
		...
		//
	    //columnObj.after("<img id='" + containerArrId + "' src='/Style%20Library/Mali/ewr074.gif' style='width:24px; vertical-align: top'; title='Click AutoComplete'/>");
	    columnObj.after("<img id='" + containerArrId + "' src='/menifa/ewr074.gif' style='width:23px; vertical-align: top'; title='Click AutoComplete'/>");
...
//debugger;			
		...
		//
	    //columnObj.after("<img id='" + containerArrId + "' src='/Style%20Library/Mali/ewr074.gif' style='width:24px; vertical-align: top'; title='Click AutoComplete'/>");
	    columnObj.after("<img id='" + containerArrId + "' src='/menifa/ewr074.gif' style='width:21px; vertical-align: top'; title='Click AutoComplete'/>");
...
//debugger;		
	    //columnObj.after("<img id='" + containerArrId + "' src='/Style%20Library/Mali/ewr074.gif' style='width:18px; vertical-align: top'; title='Click AutoComplete'/>");
	    columnObj.after("<img id='" + containerArrId + "' src='/menifa/ewr074.gif' style='width:18px; vertical-align: top'; title='Click AutoComplete'/>");
...
//debugger;		
	    ...
	    //columnObj.after("<img id='" + containerArrId + "' src='/Style%20Library/Mali/ewr074.gif' style='width:24px; vertical-align: top'; title='Click AutoComplete'/>");
	    columnObj.after("<img id='" + containerArrId + "' src='/menifa/ewr074.gif' style='width:23px; vertical-align: top'; title='Click AutoComplete'/>");
	    //columnObj.after("<img id='" + containerArrId + "' src='C:\\Users\\elig\\Desktop\\arrow-down-01-128.png' style='width:22px; vertical-align: top; border-style:solid; border-color:gray; border-width:1px'; title='Click AutoComplete'/>");
