...
function getGuid(){
     ...
     // var qs = parent.location.search.substring(1, parent.location.search.length);
      ...
      if(document.getElementById('ctl00_ctl37_g_e42030f4_76bd_433f_ac3f_f1ba04ccb9ee_FormControl0_V1_I1_T3')!=null&&param!=null){
setGuid(param,qs);}
...
if(document.getElementById('ctl00_ctl37_g_e42030f4_76bd_433f_ac3f_f1ba04ccb9ee_FormControl0_V1_I1_T3').value==""){

document.getElementById('ctl00_ctl37_g_e42030f4_76bd_433f_ac3f_f1ba04ccb9ee_FormControl0_V1_I1_T4').focus();
$("input[id='ctl00_ctl37_g_e42030f4_76bd_433f_ac3f_f1ba04ccb9ee_FormControl0_V1_I1_T4']").val(qs);
document.getElementById('ctl00_ctl37_g_e42030f4_76bd_433f_ac3f_f1ba04ccb9ee_FormControl0_V1_I1_T4').blur();


document.getElementById('ctl00_ctl37_g_e42030f4_76bd_433f_ac3f_f1ba04ccb9ee_FormControl0_V1_I1_T3').focus();
$("input[id='ctl00_ctl37_g_e42030f4_76bd_433f_ac3f_f1ba04ccb9ee_FormControl0_V1_I1_T3']").val(lookupVal);
document.getElementById('ctl00_ctl37_g_e42030f4_76bd_433f_ac3f_f1ba04ccb9ee_FormControl0_V1_I1_T3').blur();





document.getElementById('ctl00_ctl37_g_e42030f4_76bd_433f_ac3f_f1ba04ccb9ee_FormControl0_V1_I1_E2').focus();}
}
catch(err){ExecuteOrDelayUntilScriptLoaded(createListItem(err.message),'sp.js'); }
}
