...
כדי לבנות את פריסת הדף ישירות מתוך קובץ HTML זה, פשוט הזן תוכן במצייני מיקום תוכן. השתמש ביוצר המקטעים ב- http://intpmoclick/_layouts/15/ComponentHome.aspx?Url=http%3A%2F%2Fintpmoclick%2F%5Fcatalogs%2Fmasterpage%2FClick%2Fviews%2FPageLayouts%2FClickHomePageLayout%2Easpx כדי ליצור ולהתאים אישית מצייני מיקום תוכן נוספים וישויות SharePoint שימושיות אחרות, ולאחר מכן העתק והדבק אותם כמקטעי HTML בקוד ה- HTML. כל העדכונים בתוך מצייני מיקום תוכן בקובץ זה יסונכרנו באופן אוטומטי עם פריסת הדף המשויכת.
...
<asp:Content runat="server" ContentPlaceHolderID="PlaceHolderPageTitle">
            ...
            <div class="flex__container" id="homepage__container">
                <div class="main__container">
                    <div data-name="WebPartZone">
                        
                        
                        <div>
                            <WebPartPages:WebPartZone runat="server" ID="mainarea" AllowPersonalization="False" FrameType="TitleBarOnly" Orientation="Vertical">
                                <ZoneTemplate>
                ...
                <div id="personalarea__container">
                    <div data-name="WebPartZone">
                        
                        
                        <div>
                            <WebPartPages:WebPartZone runat="server" ID="personalarea" AllowPersonalization="False" FrameType="TitleBarOnly" Orientation="Vertical">
                                <ZoneTemplate>
