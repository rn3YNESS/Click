...
כדי לבנות את פריסת הדף ישירות מתוך קובץ HTML זה, פשוט הזן תוכן במצייני מיקום תוכן. השתמש ביוצר המקטעים ב- http://pmoclick19/_layouts/15/ComponentHome.aspx?Url=http%3A%2F%2Fpmoclick19%2F%5Fcatalogs%2Fmasterpage%2FClick%2Fhtml%2FPageLayouts%2FReminderPL%2Easpx כדי ליצור ולהתאים אישית מצייני מיקום תוכן נוספים וישויות SharePoint שימושיות אחרות, ולאחר מכן העתק והדבק אותם כמקטעי HTML בקוד ה- HTML. כל העדכונים בתוך מצייני מיקום תוכן בקובץ זה יסונכרנו באופן אוטומטי עם פריסת הדף המשויכת.
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div data-name="WebPartZone">
                        ...
                        <div>
                            <WebPartPages:WebPartZone runat="server" ID="RemindersWPZone" AllowPersonalization="False" FrameType="TitleBarOnly" Orientation="Vertical">
                                <ZoneTemplate>
